...
politica_optima_infinita = calcular_q_infinito(lambda_, K, H_costo_almacenamiento_anual, X, lamb_diario)

# Inventario máximo DIARIO
inv_maximo_infinita = inventario_maximo(politica_optima_infinita, X, lamb_diario)
...
_t_ = duracion_lote(politica_optima_infinita, X)
